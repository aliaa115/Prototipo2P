using CapaDiseno;
using Prototipo2P.Mantenimientos.Forms;
using System;
using System.Drawing;
using System.Windows.Forms;
using Prototipo2P.Proceso.MovimientoInventario.Forms;
...
namespace Prototipo2P
{
    public partial class MDI_SegundoParcial : Form
    {
        ...
        {
            Frm_Mantenimiento mantenimiento = new Frm_Mantenimiento(usuario, tabla, nombreBd);
            mantenimiento.Show();
