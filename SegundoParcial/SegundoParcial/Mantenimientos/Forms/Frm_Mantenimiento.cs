...
using SegundoParcial.Mantenimientos.Procesos;
...
namespace SegundoParcial.Mantenimientos.Forms
{
    public partial class Frm_Mantenimiento : Form
    {
        ...
        public Frm_Mantenimiento(string user, int tbl, string nombreBd, Color color)
        {
            InitializeComponent();

            Pnl_titulo.BackColor = color;
            Btn_MovInventario.BackColor = color;
